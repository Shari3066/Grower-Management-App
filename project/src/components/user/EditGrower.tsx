...
const EditGrower: React.FC = () => {
  const { id } = useParams<{ id: string }>();
  const { getGrowerById, updateGrower } = useGrowers();
  ...
  useEffect(() => {
    if (id) {
      const grower = getGrowerById(id);
      if (grower) {
        setFormData({
          hybridName: grower.hybridName,
          growerName: grower.growerName,
          fatherName: grower.fatherName,
          village: grower.village,
          acres: grower.acres.toString(),
          gpsCoordinates: grower.gpsCoordinates,
          femaleSowDate: grower.femaleSowDate,
          maleSowDate: grower.maleSowDate,
          femalePackets: grower.femalePackets.toString(),
          malePackets: grower.malePackets.toString(),
          femaleLotNo: grower.femaleLotNo,
          maleLotNo: grower.maleLotNo,
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold text-green-800 mb-6">Edit Grower</h1>
